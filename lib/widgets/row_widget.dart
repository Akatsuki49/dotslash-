      ...
      child: SingleChildScrollView(
        ...
        child: Row(
          children: [
            ...
            ChotaWidget(unitNo: u1, unitTitle: "Unit 1"),
            ChotaWidget(unitNo: u2, unitTitle: "Unit 2"),
            ChotaWidget(unitNo: u3, unitTitle: "Unit 3"),
            ChotaWidget(unitNo: u4, unitTitle: "Unit 4"),
          ],
        ),
      ));
}
